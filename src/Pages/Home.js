...
function Home() {
    return (
        <header class="App w3-container w3-padding-32 w3-center w3-black mx-auto" id="home">
            <h1 class="w3-jumbo main-header">Gelo Baring </h1>
            <p class="subheader lead">Digital Content Specialist. Full-stack Web Developer. UI/UX Designer. Photographer. Hiker.</p>
