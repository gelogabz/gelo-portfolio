...
function About() {
    return (
        <section class="w3-content w3-justify w3-text-light-grey w3-padding-64 ">
            <div class="container-xl align-items-center px-5">
                <h2 class="text-light fw-bolder">Angelo Gabriel Baring</h2>
                <hr class="w3-opacity" />
